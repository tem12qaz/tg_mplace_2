...
DELETE_PRODUCT_ALERT = '''Удаление нельзя отменить'''

SELLER_PRODUCTS_MESSAGE = '''Товары категории <b>"{name}"</b>'''

CREATE_REVIEW_MESSAGE = '''Оставить отзыв'''

REVIEW_MESSAGE = '''Отзывы'''
...
DEAL_CREATED_MESSAGE = '''Мы свяжемся с Вами в ближайшее время для уточнения деталей заказа и рассчета стоимости'''

SELECT_SHOP_MESSAGE = 'Выберите магазин'

RATING = '''
Рейтинг <b>{rating}/5</b>'''


SHOP_DEAL_MESSAGE = '''<b>Заявка</b>
...
SELECT_CAT_MESSAGE = 'Выберите категорию'
SELECT_PRODUCT_MESSAGE = 'Выберите товар'


INFO_PRODUCT_MESSAGE = '''
<b>{name}</b>
...
MAIL_MESSAGE = '''Отправьте одну фотографию (если требуется),
...
CREATE_FORM_MESSAGE = '''Создание формы заявки. Вы можете указать до 5 полей,
которые покупатели будут заполнять при покупке.
Введите первое поле'''

CREATE_FORM2_MESSAGE = '''Введите второе поле'''
CREATE_FORM3_MESSAGE = '''Введите третье поле'''
CREATE_FORM4_MESSAGE = '''Введите четвертое поле'''
CREATE_FORM5_MESSAGE = '''Введите последнее поле'''
FORM_SAVED_MESSAGE = '''Форма сохранена'''

SELECT_FORM_MESSAGE = '''В какой форме вам удобней заполнить заявку?'''

SEND_MESSAGE = '''Отправьте '''

BID_ROW = '''<b>{field}:</b> {value}
